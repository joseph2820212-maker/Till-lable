...
| L5 | Currency independent of language: GBP, EUR, TRY, AED, SAR, KWD (3 decimals), JPY (0 decimals) render with the correct decimals from exact minor units |
| L6 | Symbol and decimal placement come from currency + label language, never from the app language (`currencyAfter()` not used) |
