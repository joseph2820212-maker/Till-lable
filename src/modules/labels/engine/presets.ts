...
export const PRESETS: StationeryProfile[] = [
  {
    ...
    ...centred(A4.widthMm, A4.heightMm, 7, 2, 70, 38), gapXMm: 0, gapYMm: 0, safeInsetMm: 2.5,
  ...
  },
  {
    ...
    ...centred(LETTER.widthMm, LETTER.heightMm, 7, 2, 70, 38), gapXMm: 0, gapYMm: 0, safeInsetMm: 2.5,
  ...
  },
  {
    ...
    ...centred(A4.widthMm, A4.heightMm, 7, 3, 63.5, 38.1, 2.5, 0), gapXMm: 2.5, gapYMm: 0, safeInsetMm: 2, cornerRadiusMm: 1.5,
  ...
  },
  {
    ...
    ...centred(A4.widthMm, A4.heightMm, 8, 3, 63.5, 33.9, 2.5, 0), gapXMm: 2.5, gapYMm: 0, safeInsetMm: 2, cornerRadiusMm: 1.5,
    material: 'adhesiveSheet', refeedSafe: false, verification: 'unverified',
    verificationSource: 'Commonly published size and count; margins centred; not yet checked against the manufacturer template',
  },
  {
    ...
    ...centred(A4.widthMm, A4.heightMm, 7, 2, 99.1, 38.1, 2.5, 0), gapXMm: 2.5, gapYMm: 0, safeInsetMm: 2, cornerRadiusMm: 1.5,
    material: 'adhesiveSheet', refeedSafe: false, verification: 'unverified',
    verificationSource: 'Commonly published size and count; margins centred; not yet checked against the manufacturer template',
  },
  {
