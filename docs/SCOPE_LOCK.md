...
| 24 Sep 2026 | **No global six-digit price cap.** Prices are measured; the fixed price size is designed for 6 digits (tickets), 5 (A6 / A5 cards), 7 (A4 card fallback) in the widest currency; wider → "This price needs a larger label format" | `labelTemplate.ts` |
